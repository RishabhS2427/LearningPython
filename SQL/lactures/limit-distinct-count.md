# Useful Expressions with SELECT Statements
...
- The first one is COUNT, COUNT is a built-in database function that retrieves the number of rows that match the query criteria.
...
- You can issue a query like this: Select COUNT(COUNTRY) from MEDALS where COUNTRY='CANADA.'
